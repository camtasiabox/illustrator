/*
  ...
  Description: Перемещает цвета палитры с одного документа в другой. Нужно указывать название вкладки.
  Date: April, 2021
  Author: Sergey Osokin, email: hi@sergosokin.ru

  Installation: https://github.com/creold/illustrator-scripts/blob/master/md/Utility.md#syncglobalcolorsnames

  Release notes:
  0.1 Initial version

  NOTICE:
  Синхронизирует названия одних и тех же глобальных цветов между открытыми документами
