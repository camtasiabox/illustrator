/*
  ...
  Description: Покраска объектов из представленных на монтажной области образцов
  ...
  Info: https://github.com/creold/illustrator-scripts/blob/master/md/Color.md#matchcolors
  ...
  NOTICE:
  Можно перекрашивать выделенные объекты в выбранные цветовые образцы на панели "Образцы". 
  Цвета задаются для контуров, составных контуров или текста.
